...
function parseCurrentWeather(data) {
    ...
    let result = {
        ...
        iconCode: current_weather.weathercode, // returns a number - get the info from open-meteo's DOCS + associate a function to attach an image for each
        feelsLikeTemp: hourly.apparent_temperature[0],
